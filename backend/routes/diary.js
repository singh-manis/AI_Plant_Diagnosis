...
router.post('/', auth, upload.single('photo'), handleUploadError, diaryController.createEntry);
...
router.put('/:id', auth, upload.single('photo'), handleUploadError, diaryController.updateEntry);
